...
from upgrade_button_class import UpgradeButton, UpgradeParams
import json
from random import choice
from will_hit_check_class import WillHitCheck

# TO DO
# # condense left face/right face character_sprite_assets dicts into one dict with left/right as nested dicts
...
# # Add new environment character_sprite_assets type:
...
NEW_GAME_DATA_DICT = {
    ...
    'upgrades': {
        'plus damage per hit': "level 1",
        'plus horizontal attack span': "level 1"
    }
}
...
player_sprite_left_face_dict = {
    'sp_1': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_1_face_left.png'),
    'sp_2': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_2_face_left.png'),
    'sp_3': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_3_face_left.png'),
    'sp_4': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_4_face_left.png'),
    'sp_5': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_5_face_left.png'),
    'sp_6': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_6_face_left.png'),
    'sp_7': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_7_face_left.png'),
    'sp_8': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_8_face_left.png'),
    'sp_9': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_9_face_left.png'),
    'sp_10': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_10_face_left.png'),
    'sp_11': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_left/sprite_11_face_left.png')
}
player_sprite_right_face_dict = {
    'sp_1': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_1_face_right.png'),
    'sp_2': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_2_face_right.png'),
    'sp_3': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_3_face_right.png'),
    'sp_4': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_4_face_right.png'),
    'sp_5': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_5_face_right.png'),
    'sp_6': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_6_face_right.png'),
    'sp_7': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_7_face_right.png'),
    'sp_8': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_8_face_right.png'),
    'sp_9': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_9_face_right.png'),
    'sp_10': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_10_face_right.png'),
    'sp_11': tk.PhotoImage(file='character_sprite_assets/player_sprite_face_right/sprite_11_face_right.png'),
}

monster_sprite_dict = {
    'monster_1': {
        'normal': {'sprite_1': tk.PhotoImage(file='character_sprite_assets/monster_sprite/monster_1_sprite.png')},
        'red': {'sprite_1': tk.PhotoImage(file='character_sprite_assets/monster_sprite/monster_1_sprite_red.png')}
    }
}
...
upgrade_sprite_dict = {
    ...
    'damage per hit 3': tk.PhotoImage(file='./upgrade_assets/ClashingSwords.png'),
    ...
    'long blade 2': tk.PhotoImage(file='./upgrade_assets/DualWield.png')
}
...
upgrade_params = UpgradeParams(sprites=upgrade_sprite_dict)

upgrades_for_purchase_list = []

upgrade_name_list = list(saved_data_dict['upgrades'].keys())

for index, upgrade_name in enumerate(upgrade_name_list):
    upgrade_button = UpgradeButton(parent_frame=upgrade_frame,
                                   column=1, row=index + 1,
                                   stats=stats,
                                   upgrade_params=upgrade_params.set_upgrade_level(
                                       upgrade_name,
                                       saved_data_dict['upgrades'][upgrade_name]),
                                   name=upgrade_name)
    upgrades_for_purchase_list.append(upgrade_button)
...
def update_purchased_upgrades():
    upgrade_data = {upgrade.name: upgrade.level for upgrade in upgrades_for_purchase_list}
    return upgrade_data
...
def save_and_quit():
    ...
    saved_data_dict['upgrades'] = update_purchased_upgrades()
...
def player_attack_loop():
    ...
    # iters through character_sprite_assets images to animate player
